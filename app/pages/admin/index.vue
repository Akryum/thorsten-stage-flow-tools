...
en:
  ...
  database: Database
  databaseDesc: Open Drizzle Studio through the admin proxy.
  logout: Logout
...
de:
  ...
  database: Datenbank
  databaseDesc: Drizzle Studio uber den Admin-Proxy offnen.
  logout: Abmelden
...
ja:
  ...
  database: Database
  databaseDesc: 管理用プロキシ経由で Drizzle Studio を開きます。
  logout: ログアウト
